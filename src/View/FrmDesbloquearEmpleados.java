 ...
 * @author jotruvel
 */
public class FrmDesbloquearEmpleados extends javax.swing.JFrame {

    /**
     * Creates new form FrmDesbloquearEmpleados
     */
    public FrmDesbloquearEmpleados() {
        initComponents();
    ...
    private void btnenviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnenviarActionPerformed
        ...
        int esCorrecto = da.desbloquear(txtusuario.getText(), txtcontraseña.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDesbloquearEmpleados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmDesbloquearEmpleados().setVisible(true);
            }
        });
    }
